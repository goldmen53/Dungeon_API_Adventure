    ...
    if choice == "toss_coin":
        ...
        if hero.gold < 1:
            ...
            if random.random() > 0.4:
                hero.gold += 50
                msg = "Вы бросили конеты и уставилсь в бездну колодца, через несколько сукунт вы услышали как монеты плюхнулись в воду.Вы уже собирались пойти по своим делам , но услышали новый всплеск в колодце и через пару секунд на замлю упал мокрый мешочек полный золота(gold+50)"
            else:
